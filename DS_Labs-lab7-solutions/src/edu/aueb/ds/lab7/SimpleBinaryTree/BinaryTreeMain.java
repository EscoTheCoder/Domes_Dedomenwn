...
public class BinaryTreeMain {
    public static void main(String[] args) {
        ...
        BinaryTreeInterface tree = new BinaryTree(root);

        TreeNode left = new TreeNode(5);
        TreeNode left1 = new TreeNode(88);
        TreeNode left2 = new TreeNode(1);

        TreeNode left11 = new TreeNode(8);
        TreeNode left12 = new TreeNode(99);

        TreeNode left122 = new TreeNode(7);

        TreeNode right = new TreeNode(32);
        ...
        BinaryTreeInterface sub = tree.getRightSubTree(left1);
